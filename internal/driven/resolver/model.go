...
type VacancyInfo struct {
	...
	CompanyLocation  string   `json:"company_location" jsonschema_description:"Location of the company HQ based on the vacancy description, if not found then based on knowledge that you know, if still not found it should be empty"`
